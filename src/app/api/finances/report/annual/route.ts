...
// GET /api/finances/report/annual?year=YYYY[&accountId=N]
//
// Full-year aggregation. Defaults to current year when no year is given.
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({ success: true, data: { year, report } })
}
